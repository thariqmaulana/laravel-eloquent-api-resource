...
class CategoryTest extends TestCase
{
    ...
    public function testResourceCollectionCustom()
    {
        ...
        $this->get("/api/categories-collection-custom")
            ->assertStatus(200)
            ->assertJson([
                'total' => 2,
                'data' => [
    ...
    public function testResourceCollectionUseAnother()
    {
        $this->seed(CategorySeeder::class);

        $categories = Category::all();

        $this->get("/api/categories-collection-implementing-another-resource-collection")
            ->assertStatus(200)
            ->assertJson([
                'total' => 2,
                'data' => [
